...
[![GoDoc](https://godoc.org/github.com/tiiuae/nollakonffi?status.svg)](https://godoc.org/github.com/tiiuae/nollakonffi)
[![Go Report Card](https://goreportcard.com/badge/github.com/tiiuae/nollakonffi)](https://goreportcard.com/report/github.com/tiiuae/nollakonffi)
[![Tests](https://github.com/tiiuae/nollakonffi/actions/workflows/go-test.yml/badge.svg)](https://github.com/tiiuae/nollakonffi/actions/workflows/go-test.yml)

## Install
Nothing is as easy as that:
```bash
$ go get -u github.com/tiiuae/nollakonffi
```
...
See https://github.com/tiiuae/nollakonffi/blob/master/examples/resolv/client.go.
...
See https://github.com/tiiuae/nollakonffi/blob/master/examples/register/server.go.
