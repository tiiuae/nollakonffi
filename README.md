...
[![GoDoc](https://godoc.org/github.com/hnybom/nollakonffi?status.svg)](https://godoc.org/github.com/hnybom/nollakonffi)
[![Go Report Card](https://goreportcard.com/badge/github.com/hnybom/nollakonffi)](https://goreportcard.com/report/github.com/hnybom/nollakonffi)
[![Tests](https://github.com/hnybom/nollakonffi/actions/workflows/go-test.yml/badge.svg)](https://github.com/hnybom/nollakonffi/actions/workflows/go-test.yml)

## Install
Nothing is as easy as that:
```bash
$ go get -u github.com/hnybom/nollakonffi
```
...
See https://github.com/hnybom/nollakonffi/blob/master/examples/resolv/client.go.
...
See https://github.com/hnybom/nollakonffi/blob/master/examples/register/server.go.
